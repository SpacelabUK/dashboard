...
public class FlowInfo {
	...
	public static class FlowChunkNumber {
		...
		public boolean equals(Object obj) {
			return obj instanceof FlowChunkNumber
					? ((FlowChunkNumber) obj).number == this.number
					: false;
		}
	...
	// Chunks uploaded
	public HashSet<FlowChunkNumber> uploadedChunks =
			new HashSet<FlowChunkNumber>();
	...
	public File checkIfUploadFinished() {
		// check if upload finished
		int count =
				(int) Math.ceil(((double) flowTotalSize)
						/ ((double) flowChunkSize));
