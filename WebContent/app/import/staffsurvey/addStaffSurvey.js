    ...
    [
        ...
        function ($scope, $modalInstance, $http, $modal, $q, study,
            ...
            $scope.dataInvalid = function () {
                return !$scope.staff || $scope.staff.length < 1 || !$scope.questions || $scope.questions.length < 1;
            };
            ...
            vnauploader.onCompleteItem = function (item, response, status,
                ...
                MatcherFactory.openMatcherModal("question", "questions",
                    response[newData], response[dbData]).result.then(function (question_message) {
                                    ...
                                    // }
                                        ...
                                        promise.then(function (response) {
                                            ...
                                            var modalInstance = $modal.open({
                                                templateUrl: //
                                                    'app/import/staffsurvey/afterStaffSurveyUpload.html',
                                                backdrop: 'static',
                                                keyboard: 'false',
                                                size: 'sm',
...
angular
    .module('app.core').controller('AfterStaffSurveyUploadModalCtrl', [
