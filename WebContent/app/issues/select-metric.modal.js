(function () {
    "use strict";
    angular.module('app.issues').controller("SelectMetricModal", SelectMetricModal);
    SelectMetricModal.$inject = [
        '$modalInstance', 'dataService', 'issueID', 'okText', 'exceptMetrics'
    ];
    function SelectMetricModal($modalInstance, dataService, issueID, okText, exceptMetrics) {
        var vm = this;
        vm.okText = okText;
